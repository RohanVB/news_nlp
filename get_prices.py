...
file_path = '/Users/rohan/Documents/Grad School/Coursework/Winter/ML & NLP/Project_Code/data/reuters_prices'
...
"""
try:
    scrape_url = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=' + 'AET' + '&outputsize=full&apikey=85UAVS4J40XLIZ71&datatype=csv'
    ...
    df.index = range(len(df['timestamp']))      # reindex dataframe
    # print(df.shape)
    df.to_csv('/Users/rohan/documents/Grad School/Coursework/winter/ML & NLP/project_code/data/reuters_prices/' + 'AET')      # save every company price into a file.
except:
    df.to_csv('/Users/rohan/documents/Grad School/Coursework/winter/ML & NLP/project_code/data/error_companies/' + 'AET')
